...
const translations = {
    ...
    guide1: {
        ...
        en: '— a button in viewport to switch between animation preview and interaction mode. In animation preview mode, use LMB and RMB to move the camera. In interaction mode, use LMB to interact and RMB to move the camera. For touchscreens, the camera moves with a two-finger tap.'
    },
    guide2: {
        ...
        en: '— hovering over the button will display the locations available for interaction and the type of interaction. For touchscreens, holding the button.'
    },
    guide3: {
